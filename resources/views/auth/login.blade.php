...
<div>
    <div class="text-center mb-6">
        ...
        <h2 class="text-3xl font-['Quicksand'] font-bold mb-2 text-center text-[#4A90E2] mt-6">Sign In</h2>
        <p class="text-gray-600">Access your KidsGuard dashboard to protect your children online</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-[#4A90E2] hover:text-[#3A80D2] transition duration-200 flex items-center" href="{{ route('password.request') }}">
        ...
        <div class="flex flex-col items-center justify-center space-y-4">
            ...
            <div class="relative w-full text-center my-4">
                ...
                <div class="relative flex justify-center">
                    <span class="px-3 bg-white text-sm text-gray-500">or sign in with</span>
                </div>
            </div>
            
            <div class="flex space-x-4 w-full">
                <button type="button" class="flex-1 flex items-center justify-center p-3 rounded-xl border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition duration-200 group">
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-gray-600">Don't have an account? 
                    <a href="{{ route('register') }}" class="font-bold text-[#4A90E2] hover:text-[#3A80D2] transition duration-200 inline-flex items-center">
                        Register
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Secure login ensures your children's data remains protected. We never share your information.
                        </p>
                    </div>
                </div>
            </div>
