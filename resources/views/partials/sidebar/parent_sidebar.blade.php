<div class="fixed left-0 top-0 h-full w-16 sm:w-20 md:w-64 bg-[#9B59B6] text-white flex flex-col justify-between transition-all duration-300 shadow-lg z-20">
    ...
    <div class="flex-1 overflow-y-auto py-2 sm:py-4">
        <ul class="space-y-1 sm:space-y-2 px-1 sm:px-2">
            ...
            <!-- Parent Games -->
            <li>
                <a href="#" class="flex flex-col md:flex-row items-center justify-center md:justify-start p-3 rounded-xl hover:bg-white/10 transition-colors duration-200 {{ request()->routeIs('parent.games') ? 'bg-white/20' : '' }}">
            ...
            <!-- Settings -->
            <li>
                <a href="#" class="flex flex-col md:flex-row items-center justify-center md:justify-start p-3 rounded-xl hover:bg-white/10 transition-colors duration-200 {{ request()->routeIs('settings') ? 'bg-white/20' : '' }}">
